  ...
  session_start();
	...
	if(isset($_GET['status'])){
		...
		if($status == "invaliduser"){
			echo "Invalid user info! <a href=login2.php>try again...</a>";
		}else if($status == "nullvalue"){
			echo "Username/password can't be empty <a href=login2.php>try again...</a>";
		}
    }
...
<body>
<form method="post" action="../data/logcheck2.php">
<center>
