...
<body >
       <table border="1" height="30px" width="40%" align="center">	     
        <tr><td colspan="7" ><h4 style="text-align:center;">User Profile Information</h4></td></tr>
        ...
        <td ><h4 ><a href='../data/deleteUser.php?username=<?=$row["Username"]?>'> <input type="button" name="delete" value="delete"></a></h4>
		 <h4 ><a href='../data/InsertUser.php?username=<?=$row["Username"]?>'> <input type="button" name="delete" value="Approve"></a>
		 </h4></td>
