...
<body>
<form method="post" action="../data/setDD.php" enctype="multipart/form-data">
<center>
<?php include_once"header.php"; ?>
<table align="center" border="1" cellspacing="1" cellpadding="1" width="65%"height="40%">
<tr align="center" >
<td colspan="2" height="40">Discover Bangladesh</td>
</tr>
<tr>
<td colspan="2"  height="25" align="right"> 
<img src="../design/pic/disbd.jpg" width="900px" height="200px"/>
</td>
</tr>
<tr>
